...
## Capitalisation
- Headings in documentation and release posts: **Title Case.** Stated in the documentation's `CONTRIBUTING.md` ("Section titles: Use Title Case formatting") and observed across component pages and the 2026.8.0 release post: "Release Overview", "Upgrade Checklist", "Thank You, Contributors".
- **Known deviation, and the rule stands.** The 2026.9.0 release post of 16 September 2026 uses sentence case throughout: "Release overview", "Upgrade checklist", "Thank you, contributors". Ruled on 2026-09-17 that the published post deviates from the rule rather than changing it. Do not follow 2026.9.0 here. A change in published copy is not a change in the rule; it is a copy that needs correcting.
