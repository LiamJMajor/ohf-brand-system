...
# Open Home Foundation: messaging
...
(Answers the objection: sounds technical, sounds like a project.)

### Press and industry
The Open Home Foundation is a tax-exempt non-profit foundation in Switzerland that owns the smart home's open infrastructure outright. It is funded by partner fees and donations, has no financial obligation to those partners, and publishes its board, its structure and its accounts. That is why it can praise a competitor's good decision and name a large company's bad one in the same month.
(Answers the objection: is this an advocacy front for a commercial interest?)

### Regulators and policy people
Interoperability in the home fails at specific, documentable choke points, and we can show you where. We took part in the European Commission process that ended with Alphabet required to open 11 Android features, and we maintain the drivers and standards that show what interoperability looks like when it is allowed to work.
(Answers the objection: would an intervention change anything?)

### Contributors and the community
Your work cannot be acquired out from under you. The foundation owns the projects, the structure is designed so it cannot be sold, and the funding pays more than 50 people to keep the lights on. Community Day and the annual report exist because the community is the thing being protected, not an audience for it.
(Answers the objection: is governance overhead, or protection?)
...
|---|---|---|
| seamless, robust, powerful, innovative, revolutionary, leverage, empower | the specific thing | validator-banned everywhere; they describe nothing (project-spec.md) |
| OHF | Open Home Foundation, then "the foundation" | names are never shortened; see naming.md |
| we believe / we are committed to | what we did | the foundation's credibility is behavioural (voice.md, "Show us doing it") |
| the community (as an audience being marketed to) | TODO | the community is the thing being protected. TODO interview for the phrasing |
| a vague criticism of "the industry" | the company and the conduct | `core/voices.md`, Criticism |
| anything that sells a product in foundation voice | route to the project | `core/escalation.md`; advocacy and selling never share a post |
