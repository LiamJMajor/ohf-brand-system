...
source: Communications Strategy & Architecture, 1.1.3 (marked incomplete in source)
owner: @liam
---

# core: proof points

A proof point is specific, verifiable and traceable to a source. Skills copy Approved phrasing verbatim and cite this file by path. A row with Verified empty or "Never" is not usable and the audit reports it.
