...
| Works with any supporting smart home system | open standards; not tied to one system | https://esphome.io/, https://esphome.io/blog/2026/08/12/the-esphome-starter-kit-is-here/ | choice | can talk directly to Home Assistant or any other smart home system that supports it | 2026-09-17 |
| Home Assistant arrival, where Home Assistant is the reader's system | device appears automatically over the local network | https://esphome.io/ | privacy | Your new device automatically pops up in Home Assistant over your local network: no cloud accounts or external servers required | 2026-09-16 (use only where the audience is known to run Home Assistant; the general claim is the row above) |
